...
import {
    ...
    contenusList,
    phenomenesList,
} from '../../utils/details/plancheDetails';
        ...
        <div>
            <Formik
                ...
                validationSchema={Yup.object({
                    ...
                    determinantSign: Yup.string()
                        .oneOf([...signesList, ''], 'Signe incorrect')
                        .required('Required'),
                ...
                onSubmit={(values, { setSubmitting }) => {
                    const res = { ...values };
                    res.determinant = {
                        value: values.determinant,
                        sign: values.determinantSign,
                    };
                    ...
                    <Form className="flex flex-col items-center justify-center md:justify-start ">
                        <div className="flex flex-col space-y-6 lg:space-y-0 lg:flex-row lg:space-x-10 xl:space-x-12 lg:items-start mb-6 lg:mb-12">
                            <div className="flex flex-col lg:items-start justify-center space-y-4 lg:space-y-8 rounded-lg border shadow-sm lg:p-6 p-3">
                                ...
                                >
                                    {localisationList.map(localisation => (
                                        <option
                                            key={localisation + plancheNumber}
                                            value={localisation}
                                        >
                                            {localisation}
                                        </option>
                                ...
                                <FormikSelect
                                    label="Signe"
                                    name="determinantSign"
                                >
                                    {signesList.map(sign => (
                                        <option
                                            key={sign + plancheNumber}
                                            value={sign}
                                        >
                                            {sign}
                                        </option>
                            ...
                            <div className="flex flex-col space-y-4 lg:space-y-8">
                                ...
                                >
                                    <h3 className="md:text-xl mb-2 md:mb-3 border-b pb-1 lg:mb-6 xl:mb-8">
                                        Contenus:{' '}
                                    </h3>
                                                ...
                                                <div
                                                    onMouseEnter={() => {
                                                        ...
                                                        contentTimeout =
                                                            setTimeout(() => {
                                                                setHoverContent(
                                                                    contentHoverInformation[
                                                                        contenu
                                                                    ]
                                                                );
                                                                setContentHoverActive(
                                                                    true
                                                                );
                                                            }, 500);
                                                    }}
                                                    key={
                                                        contenu + plancheNumber
                                                    }
                                                >
                                                    <FormikCheckbox
                                                        name="contenus"
                                    ...
                                    {isContentHoverActive && (
                                        <HoverInfo
                                            content={hoverContent}
                                            visible={isContentHoverActive}
                                        />
                                    )}
                                ...
                                >
                                    <h3 className="md:text-xl mb-2 md:mb-3 lg:mb-6 xl:mb-8 border-b pb-1">
                                    ...
                                    {isPhenoHoverActive && (
                                        <HoverInfo
                                            content={hoverPheno}
                                            visible={isPhenoHoverActive}
                                        />
                                    )}
                                    <FormikTextArea
                                        label="Commentaires"
                                        name="phenomenesComment"
                                        rows={inputRows}
                                        cols={inputCols}
                                    />
                                </div>
                                        ...
                                        {resultArray.map(resultNumber => {
                                            return (
                                                <div
                                                    ...
                                                    className={`w-1 h-1 md:w-2 md:h-2 lg:w-3 lg:h-3 rounded-full cursor-pointer ${isActive[resultNumber]}`}
                                                ></div>
                                            );
                                        })}
                                    </div>
                        ...
                        <button
                            className="text-xl text-color1 bg-green-50 p-3 rounded-lg hover:bg-gray-100 w-1/8 border shadow-sm lg:p-6 p-3 mx-4 lg:mx-0"
                            type="submit"
                        >
                            Sauvegarder et passer à la planche suivante
                        </button>
                    </Form>
                </div>
            </Formik>
