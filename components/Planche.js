...
const Planche = ({
  ...
  const [initValues, setInitValues] = useState({
    ...
    determinant:
      savedPlanches.planches[plancheNumber][resultNumber]?.determinant?.value ??
      'Aucun',
    // determinantComment: initDeterminantComment,
    determinantSign:
      savedPlanches.planches[plancheNumber][resultNumber]?.determinant?.sign ??
      'Aucun',
    contenus:
    ...
    phenomenesComment:
      savedPlanches.planches[plancheNumber][resultNumber]?.phenomenesComment ??
      '',
    answerTime:
      savedPlanches.planches[plancheNumber][resultNumber]?.answerTime ?? 0,
  });
