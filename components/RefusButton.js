...
const RefusButton = () => {
    ...
    return (
        <div className="text-xl text-color1 p-3 cursor-pointer rounded-lg hover:bg-gray-100 w-1/8 border shadow-md lg:p-6 p-3 mx-4 lg:mx-0" onClick={handleRefus}>Refus</div>
    )
}
